  ...
  it("Test parseReport with valid Linux Report", () => {
    const report = {
      ...
      disks: [
        ...
        {fs: '/dev/sda', type: 'ext4', size: 7997210226688, used: 3803645599744, available: 4193564626944, use: 47.56, mount: '/'},
      ],
      uptime: 300,
      reporterUptime: 200,
      timestamp: 1621176090,
    ...
    const expectedReport = {
      ...
      disks: [
        ...
        {fs: '/dev/sda', type: 'ext4', size: 7447.98, used: 3542.42, available: 3905.56, use: 47.56, mount: '/'}, 
      ],
      uptime: { pure: 300, formatted: '0d 0h 5m 0s' },
      reporterUptime: 200,
      timestamp: 1621176090,
